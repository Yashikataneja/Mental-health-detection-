...
// import { FaGlobe, FaLinkedin, FaPhone, FaExternalLinkAlt, FaShieldAlt, FaInfoCircle, FaArrowRight, FaRobot } from "react-icons/fa";
...
//     bookLink: "https://www.practo.com/gurgaon/doctor/nisha-khanna-1-psychiatrist?no_app_promo=true",
...
//     bookLink: "https://www.practo.com/kolkata/therapist/subhra-banerjee-paul",
//     website: "https://www.practo.com/",
//     linkedin: "https://my.linkedin.com/company/practo-technologies-pvt-ltd",
//   },
//   {
...
//     bookLink: "https://www.practo.com/kottayam/doctor/sebin-s-kottaram-psychologist",
//     website: "https://www.practo.com/",
//     linkedin: "https://my.linkedin.com/company/practo-technologies-pvt-ltd",
//   },
//   {
...
//     bookLink: "https://www.practo.com/chennai/therapist/finita-glory-roy-psychologist",
//     website: "https://www.practo.com/",
//     linkedin: "https://my.linkedin.com/company/practo-technologies-pvt-ltd",
//   },
// ];
...
//         id="hero"
//         data-reveal
//         className={`w-full px-6 py-20 md:px-12 xl:px-20 2xl:px-32 transition-all duration-1000 ${revealClass("hero")}`}
//       >
//         <div className="grid items-center gap-16 md:grid-cols-2">
//           {/* Left */}
//           <div className="flex flex-col justify-center">
//             {/* fix 2 — hero eyebrow label */}
//             <p className="mb-4 text-sm font-semibold uppercase tracking-[0.28em] text-indigo-500">
//               Trusted Support
//             </p>
...
//               Mannlytics helps you reflect and understand emotions, but reaching trusted support also matters. Here are verified help resources and counseling options.
//             </p>
//           </div>
...
//         <div className={`flex gap-4 rounded-2xl border p-6 shadow-md ${
//           darkMode ? "border-amber-800/40 bg-amber-900/20 text-white" : "border-amber-200 bg-amber-50 text-slate-800"
//         }`}>
//           <FaInfoCircle className={`mt-0.5 shrink-0 text-xl ${darkMode ? "text-amber-400" : "text-amber-500"}`} />
//           <div>
//             <p className={`text-sm font-semibold uppercase tracking-widest ${darkMode ? "text-amber-300" : "text-amber-600"}`}>
//               Important Note
//             </p>
//             <p className={`mt-2 text-sm leading-7 ${mutedText}`}>
//               Mannlytics provides supportive emotional insights and is not a substitute for professional medical advice, diagnosis, or treatment. In immediate danger or emergency situations, contact emergency services right away.
//             </p>
//           </div>
//         </div>
//       </section>
...
//         <svg viewBox="0 0 1440 60" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-10">
...
//         id="helplines"
//         data-reveal
//         className={`w-full px-6 py-12 md:px-12 xl:px-20 2xl:px-32 transition-all duration-1000 ${revealClass("helplines")}`}
//       >
//         <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-indigo-500">
...
//         </p>
//         <div className="mb-8">
//           <h2 className={`text-3xl font-bold ${headingText}`}>Counseling Support</h2>
...
//                 <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-100">AI Support</p>
//               </div>
//               <h3 className="text-3xl font-bold text-white md:text-4xl">
//                 Want to talk through how you feel?
//               </h3>
//               <p className="mt-4 text-blue-50 leading-7">
//                 Use Mannlytics AI to reflect on your emotions, understand your patterns, and take the next step toward feeling better.
//               </p>
//             </div>
