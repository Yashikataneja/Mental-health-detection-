...
<button
onClick={()=>setShowMenu(!showMenu)}
className="flex items-center gap-3 cursor-pointer bg-white px-3 py-1 rounded-full shadow hover:shadow-md transition"
>
...
<div className="absolute right-0 mt-3 bg-white shadow-lg rounded-lg w-44 py-2 transition-all duration-200">
...
<div className="w-36 h-36 rounded-full overflow-hidden bg-gray-200 border-4 border-indigo-300 shadow-lg">
...
<div className="absolute bottom-0 right-0 bg-indigo-600 text-white p-2 rounded-full shadow pointer-events-none">
📷
</div>
...
<button
onClick={()=>setIsEditing(true)}
className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:scale-105 transition text-white px-6 py-2 rounded-lg w-44"
>
Edit Profile
</button>
...
className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:scale-105 transition text-white px-6 py-2 rounded-lg w-44"
>
Save Changes
</button>
...
<p className="text-gray-500 text-sm">Last Emotion</p>
<p className="text-xl font-bold capitalize">{lastEmotion}</p>
</div>
