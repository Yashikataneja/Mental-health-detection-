...
//       // Trigger emotion-based notification
//       const emotionNotifications = {
...
//       const notificationData = emotionNotifications[notificationEmotionKey] || emotionNotifications.neutral;
...
//     Happy:   { msg: "Love that energy! 🌟 Let's capture this feeling — write a journal entry to make the most of today.", color: "text-yellow-500", bg: darkMode ? "bg-yellow-500/10" : "bg-yellow-50", border: "border-yellow-200" },
//     Neutral: { msg: "A calm day is a good day. ☀️ Ready to reflect? Your journal is waiting.", color: "text-slate-500", bg: darkMode ? "bg-slate-500/10" : "bg-slate-50", border: "border-slate-200" },
//     Sad:     { msg: "It's okay to feel this way. 💙 Let's understand what's going on — write it out and let the AI help.", color: "text-blue-500", bg: darkMode ? "bg-blue-500/10" : "bg-blue-50", border: "border-blue-200" },
//     Anxious: { msg: "Take a breath. 🌬️ You're safe here. Writing down your thoughts can really help ease the mind.", color: "text-violet-500", bg: darkMode ? "bg-violet-500/10" : "bg-violet-50", border: "border-violet-200" },
//     Stressed:{ msg: "You're carrying a lot. 🌿 Let's break it down together — start with a few lines in your journal.", color: "text-orange-500", bg: darkMode ? "bg-orange-500/10" : "bg-orange-50", border: "border-orange-200" },
//     Angry:   { msg: "Frustration is valid. 🔥 Writing it out can help you process and release it. Let's start.", color: "text-red-500", bg: darkMode ? "bg-red-500/10" : "bg-red-50", border: "border-red-200" },
//   };
...
//           <div
//             className={`w-full max-w-sm rounded-2xl border p-5 shadow-2xl backdrop-blur-xl checkin-msg-pop ${
//               checkinMsg.bg
//             } ${checkinMsg.border}`}
//           >
...
//               <div className={`h-1 rounded-full checkin-progress ${checkinMsg.color.replace("text-", "bg-")}`} />
//             </div>
//           </div>
//         </div>
//       )}
...
//           <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => { setShowMoodCheckin(false); setCheckinDone(true); localStorage.setItem(`moodCheckinDate_${currentUserEmail}`, new Date().toDateString()); }} />
...
//             {/* Close */}
//             <button
//               onClick={() => { setShowMoodCheckin(false); setCheckinDone(true); localStorage.setItem(`moodCheckinDate_${currentUserEmail}`, new Date().toDateString()); }}
...
//           return (
//             <div className={`calm-popup absolute bottom-full right-0 mb-4 flex flex-col gap-3 rounded-3xl shadow-2xl border p-6 w-80 ${
