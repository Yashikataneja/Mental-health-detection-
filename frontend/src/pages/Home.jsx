          ...
          <div className="relative w-full max-w-2xl pt-16">
            ...
            >
              <img
                src={picdetect}
                alt="AI mental health analysis"
                className="h-[560px] w-full rounded-[1.5rem] object-cover transition duration-700 hover:scale-105"
              />
      ...
      >
        ...
        >
          <img
            src={picbenifits}
            alt="Benefits of Mannlytics"
            className="h-[510px] w-full rounded-[1.5rem] object-cover transition duration-700 hover:scale-105"
          />
        </div>
